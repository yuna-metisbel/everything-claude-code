...
| # | パネル | URL |
|---|--------|-----|
| 1〜8 | 02 店舗1 〜 02 店舗8 | `https://m-sns.net/shop/login/` |
| 9 | X | `https://x.com/login` |

8つとも同じ URL ですが、**パネルごとにログイン状態が分かれている**ので、それぞれ別アカウントで
ログインできます。キャスト用（`https://m-sns.net/cast/login/`）に変えたいパネルは、設定画面で
URL を書き換えるか、いったん削除して「追加するサイト」から「02 キャスト用」を選び直してください。
